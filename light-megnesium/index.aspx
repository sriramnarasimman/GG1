    ...
    <body>
        ...
        <form id="form1" runat="server">
            ...
            <div class="product-banner">
                <img src="../assets/images/light-mg/banner.jpg">
                <div class="banner-center">
                    <h4>Light Magnesium </h4>
                </div>
            </div>
            <!--======== END: BANNER ========-->
                ...
                <div class="col-lg-12 row mx-auto my-4">
                    <div class="col-lg-4 col-sm-6 product-lft">
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="active" href="../light-megnesium/">Light Magnesium</a>
                            </li>
                            <li>
                        ...
                        <div class="prod-lft-img">
                            <img src="../assets/images/light-mg/light-Megnesium.png">
                        </div>
                    </div>
                    <div class="col-lg-8 product-rgt">
                        <h4><span>Light Magnesium</span><br>Carbonate</h4>
                        <p>
                            Light magnesium carbonate is a free flowing, high purity product. Magnesium carbonate is light, white and odourless. It is practically insoluble in water but dissolves in dilute acids, producing a strong effervescence. We produce very high quality Light Magnesium Carbonate matching pharma standards to deliver excellent results whatever the application. We have the capacity to deliver the chemical in powder, granule or pellet form as required.
                        </p>

                        <h5>Uses</h5>
                        <ul>
                            <li>As a base to treat dyspepsia, rheumatism and gout</li>
                            <li>As an acid acceptor in the production of magnesium derivatives and high purity magnesium compounds</li>
                            <li>In pharmaceutical industries for antacid preparations</li>
                            <li>As an anti-caking agent and fragrance retainer</li>
                            <li>In  talcum powder, rubber, glass, ink industries</li>
                            <li>In latex industry to manufacture surgical gloves and condom</li>
                            <li>In ceramic industry</li>
                            <li>In the manufacture of readymade food products such as vada mix, idli mix, onion and garlic powder, free flow salts and all types of fry-ums.</li>
                        </ul>

                        <div class="col-lg-12 row mx-0 px-0 product-zoom-view-1">
                            <div class="col-lg-4 col-sm-4 prod-image-list" data-src="../assets/images/light-mg/Product-img.jpg">
                                <img src="../assets/images/light-mg/Product-img.jpg">
                            </div>
                            <div class="col-lg-4 col-sm-4 prod-image-list" data-src="../assets/images/light-mg/product-img2.jpg">
                                <img src="../assets/images/light-mg/product-img2.jpg">
                            </div>
                            <div class="col-lg-4 col-sm-4 prod-image-list" data-src="../assets/images/light-mg/product-img3.jpg">
                                <img src="../assets/images/light-mg/product-img3.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 row mx-0 download-list">
                    <div class="col-lg-4 col-sm-4">
                        ...
                        <div class="download-btn">
                            <a href="../assets/pdf/light-mg/Light-Magnesium-Carbonate-IP-Grade.pdf" target="_blank"> <img src="../assets/images/icons/doc-file.png"> Download PDF</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-4">
                        <h6>MSDS</h6>
                        ...
                        <div class="download-btn">
                            <a href="../assets/pdf/light-mg/Light-Magnesium-Carbonate-MSDS.pdf" target="_blank"> <img src="../assets/images/icons/doc-file.png"> Download PDF</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-4">
                        <h6>Certification</h6>
                        ...
                        <div class="download-btn">
                            <a href="../assets/pdf/light-mg/Pharma-Certificate.pdf" target="_blank"> <img src="../assets/images/icons/doc-file.png"> Download PDF</a>
                        </div>
                    </div>
                </div>
            </div>
