    ...
    <body>
        ...
        <!-- End: Mobile Menu -->
            ...
            <div class="product-banner">
                <img src="../assets/images/carbon-dioxide/banner.jpg">
                <div class="banner-center">
                    <h4>Carbon Dioxide Gas </h4>
                </div>
            </div>
            <!--======== END: BANNER ========-->
                ...
                <div class="col-lg-12 row mx-auto my-4">
                    <div class="col-lg-4 col-sm-6 product-lft">
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="active" href="../carbon-dioxide-gas/">Carbon Dioxide Gas</a>
                            </li>
                            <li>
                        ...
                        <div class="prod-lft-img">
                            <img src="../assets/images/carbon-dioxide/gas-small.jpg">
                        </div>
                    </div>
                    <div class="col-lg-8 product-rgt">
                        <h4><span>Carbon</span><br> Dioxide Gas </h4>
                        <p>
                            Food, oil and chemical industry grade CO2 gas is processed to match industry standards. We have storage capacity of 50 MTs and can deliver the required quantity on time.
                        </p>
                        <p>
                            We are one of the very few companies that deliver CO2 gas in tankers. We also pack it in leak proof cylinders, which are examined by the auditors at our modern quality-inspecting laboratory before shipment.
                        </p>

                        <h5>Uses</h5>
                        <ul>
                            <li>In manufacture of carbonated soft drinks and beverages</li>
                            <li>In manufacture of fire extinguishers</li>
                            <li>In the medical industry</li>
                            <li>For welding</li>
                        </ul>

                        <div class="col-lg-12 row mx-0 px-0 product-zoom-view-1">
                            <div class="col-lg-4 col-sm-4 prod-image-list" data-src="../assets/images/carbon-dioxide/product-img1.jpg">
                                <img src="../assets/images/carbon-dioxide/product-img1.jpg">
                            </div>
                            <div class="col-lg-4 col-sm-4 prod-image-list" data-src="../assets/images/carbon-dioxide/product-img2.jpg">
                                <img src="../assets/images/carbon-dioxide/product-img2.jpg">
                            </div>
                            <div class="col-lg-4 col-sm-4 prod-image-list" data-src="../assets/images/carbon-dioxide/product-img3.jpg">
                                <img src="../assets/images/carbon-dioxide/product-img3.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 row mx-0 download-list">
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="download-btn">
                            <a href="../assets/pdf/carbon-dioxide/Gaseous-CO2.pdf" target="_blank"> <img src="../assets/images/icons/doc-file.png"> Download PDF</a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6">
                        <h6>MSDS</h6>
                        ...
                        <div class="download-btn">
                            <a href="../assets/pdf/carbon-dioxide/CO2-MSDS.pdf" target="_blank"> <img src="../assets/images/icons/doc-file.png"> Download PDF</a>
                        </div>
                    </div>
